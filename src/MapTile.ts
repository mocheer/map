...
export class MapTile {
    ...
    toString(): string {
        ...
        var str = "provider:" + this.provider.toString() + "\n" +
            ...
            "tileLonLat:" + (this.provider.coordinateLocation(this.coordinate).toString()) + "(切片经纬度坐标)\n" +
            "tileMinLonLat:" + (this.provider.coordinateLocation(this.coordinate.down()).toString()) + "(切片经纬度坐标)\n" +
            "tileLonLat2:" + (this.provider.coordinateLocation(this.coordinate.right().down()).toString()) + "(切片经纬度坐标)\n" +
