...
import {lonLat_xy_bj54,xy_LonLat_bj54} from '../math/GaussKruger'
/**
 * 
 */
export class GaussKrugerProjection  extends AbstractProjection {
    centerLon:number
    constructor(zoom: number, T: Transformation,centerLon:number)
    {
       super(zoom,T)
   ...
   /**
    ...
    rawProject(point: any[]): any[] {
         return lonLat_xy_bj54(point[0],point[1],this.centerLon,0,0);
    }
   /**
    ...
    rawUnproject(point: any[]): any[] {
        return xy_LonLat_bj54(point[0],point[1],this.centerLon,0,0);
    }
    /**
